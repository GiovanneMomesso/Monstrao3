                ...
                <table class='estilo1'>
                    ...
                    <c:forEach var="categoria" items="${categoriaDao.listar()}">
                        <tr class='estilo1'>
                            ...
                            <td class='estilo1'><a href="ControladoraCategoria?action=deletar&id=${categoria.idCategoria}" onclick="return confirm('Você tem certeza que deseja deletar esta categoria? Serão deletados os produtos vinculados a ela também.');" class='search-submit'>Deletar</a></td>
                        </tr>	
                    </c:forEach>
                </table>
